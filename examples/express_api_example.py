...
breakdown_state = psx.BreakDownState(tm1, tm2)
process_breakdown_state = psx.ProcessBreakdownState(tm1, tm2, p1)
...
m1 = psx.Material([p1, p2], p3)
m2 = psx.Material([p2, p2], p3)

arrival_time_model_m1 = psx.FunctionTimeModel("normal", 50.0, 5.0)
arrival_time_model_m2 = psx.FunctionTimeModel("normal", 50.0, 5.0)
