...
s1 = psx.FunctionTimeModel("constant", 0.5, ID="s1")
setup_state_1 = psx.SetupState(s1, p1, p2, "S1")
setup_state_2 = psx.SetupState(s1, p2, p1, "S2")

machine = psx.ProductionResource([p1, p2], [0,0], 1, states=[setup_state_1, setup_state_2], ID="machine")
...
arrival_model_1 = psx.FunctionTimeModel("constant", 1, ID="arrival_model_1")
arrival_model_2 = psx.FunctionTimeModel("constant", 1, ID="arrival_model_2")
