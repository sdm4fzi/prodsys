...
import prodsys
from prodsys.optimization import evolutionary_algorithm, simulated_annealing, tabu_search, math_opt
...
class OptimizationRun(BaseModel):
    ...
    found_adapters: List[prodsys.adapters.JsonProductionSystemAdapter] = []
